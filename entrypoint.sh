...
UUID=${UUID:-'86a2d4f2-f6bb-4e5f-9ffe-6bbbee2b5cd5'}
VMESS_WSPATH=${VMESS_WSPATH:-'/86a2d4f2-f6bb-4e5f-9ffe-6bbbee2b5cd5-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/86a2d4f2-f6bb-4e5f-9ffe-6bbbee2b5cd5-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/86a2d4f2-f6bb-4e5f-9ffe-6bbbee2b5cd5-trojan'}
SS_WSPATH=${SS_WSPATH:-'/86a2d4f2-f6bb-4e5f-9ffe-6bbbee2b5cd5-shadowsocks'}
